...
This runtime has protected-merge, deployment-trace and live-smoke evidence. The password-recovery initialization fix itself remains physically **PENDING** because the deployed retest was blocked at the email-send step by a Supabase Auth rate limit before a fresh recovery link could be issued. That block must not be relabeled as either a recovery regression failure or a physical PASS.
