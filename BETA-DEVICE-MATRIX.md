...
- Current browser/PWA runtime candidate: PR #554 / OPPO physical-QA remediation / `6f7d56f0b68551c731d88d69e34286a8f2ecca70` — `kinaraidee-beta-v16`; deployment status is **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE**; Runtime merge/deployed SHA is `0f96414295f2a5f5abd7da346aa8a58d47c10f63`.
- Verified current deployment evidence: **PASS** for exact merged-main SHA `0f96414295f2a5f5abd7da346aa8a58d47c10f63`; Pages `34137902178`, main Live Smoke `34137949343`, Auth Password Security Live Smoke `34137949293`, and Campaign 3000 Premium Live Smoke `34137949307` = SUCCESS. This is deployment evidence only. Issue #551 Home-nav physical FAIL and Issue #552 / TC-03 physical FAIL remain **OPEN / NOT PHYSICAL PASS** until the deployed remediation is retested on the affected OPPO Reno13 5G / Android 16 standalone-PWA scope. TC-08 allow from the same 2026-09-07 OPPO session remains **INCONCLUSIVE** because a fresh permission-grant prompt/state was not captured. Public Beta remains incomplete.
- Historical Home V3 runtime: PR #548 / `6eac2ce642a907414260518d0435263b3e54f425`; verified deployed descendant `46136f5ca6322847545289c18233320139147aa2` with Pages `34087987096`, main Live Smoke `34088055637`, Auth Password Security Live Smoke `34088055663`, and Campaign 3000 Premium Live Smoke `34088055657`. This trace remains historical and is superseded as current runtime deployment lineage by PR #554.
- Historical Nearby remediation runtime: PR #546 / `e0523e6cab49b09e910ba66f2ad18351f491d19a`; verified deployed descendant `a6db511e0bbd6be9038bbc63a06fb5e1702006d3` with Pages `34013867862`, main Live Smoke `34013888880`, and Auth Password Security Live Smoke `34013888842`. This trace remains historical and is not current physical evidence.
- Historical PR #520 referral-summary Edge-only runtime: source `4e2e1789921aa6fd73b2677ac5def2bc35a8be73`; deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d`; Pages `33898258213` and main Live Smoke `33898314400` = SUCCESS. After the recorded scoped signed-in physical `EDGE` acceptance, the Member referral-summary browser path became Edge-only through JWT-verified `member-referral-api`; the temporary caller-scoped RPC fallback was removed and the later RPC execute revocation was separately verified. This historical deployment/security/physical evidence does not replace current runtime or create referral conversion, Campaign 3,000 eligibility, user-count growth or revenue evidence.
...
- Current browser/PWA remediation runtime candidate `6f7d56f0b68551c731d88d69e34286a8f2ecca70` has **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE** on exact deployed SHA `0f96414295f2a5f5abd7da346aa8a58d47c10f63`; Pages `34137902178`, main Live Smoke `34137949343`, Auth Password Security Live Smoke `34137949293`, and Campaign 3000 Premium Live Smoke `34137949307` are successful deployment evidence only. Issues #551/#552 remain **OPEN physical FAILs pending retest** on the recorded OPPO scope; TC-08 allow in that session remains **INCONCLUSIVE**. Issues #524/#545 remain **PENDING / NOT PASS / NOT FAIL** for affected iPhone scopes, and historical PR #537 password-recovery initialization physical retest remains PENDING because recovery-email issuance was rate-limited. Historical PR #520 referral-summary signed-in `EDGE` interaction and post-cutover RPC execute revocation/Advisor recheck retain their scoped evidence. Historical PR #509 Product Event deployment/controlled-ingress evidence remains scoped; separate OPPO Product Event physical QA PASS is not real-user traction. Historical PR #499 referral/acquisition deployment/schema/privacy-fix evidence remains scoped and no referred-signup/referral-conversion PASS is inferred.
...
## 2026-09-04 / 2026-09-05 / 2026-09-07 — Traceable OPPO Android Chrome/PWA sessions (current scoped evidence)
...
|---|---|---|---|
| OPPO Reno13 5G (CPH2689), normal Chrome tab / dedicated Incognito sessions / installed standalone PWA where recorded | Android 16 / ColorOS 16.0.5 / Chrome lineage 152.0.7977.64 | Existing scoped PASS: TC-11 Feedback, TC-12 Partner, Reduced Motion, Auth recovery/sign-in/signup/confirmation, NF-07 v15→v16, Product Event QA, referral-summary signed-in `EDGE`. 2026-09-07 standalone-PWA regression session: TC-02 PASS; TC-09 Location Deny PASS after the site was explicitly blocked and the app showed a denial/fallback state without stale success; TC-10 Google Maps fallback PASS; TC-13 PWA reopen PASS; TC-14 Offline shell + offline Surprise PASS; NF-01 PASS; NF-02 duplicate guard PASS after rapid taps produced one result; NF-08 interrupted recovery PASS; NF-10 online recovery PASS. Issue #551 = FAIL/OPEN because Home V3 bottom nav was clipped/covered on Home while functional/other screens rendered correctly. Issue #552 / TC-03 = FAIL/OPEN because `ซุป/ต้ม` produced `ผัดพริกแกงหมู` as `ซุป`. | PR #554 remediation is deployed but Issues #551/#552 still require OPPO physical retest before PASS/closure. TC-08 allow from 2026-09-07 remains INCONCLUSIVE because no fresh grant prompt/state was captured. Weak/leaked-password rejection remains NOT VERIFIED because server-side protection is blocked separately; referred-signup/referral-attribution remains NOT VERIFIED; Product Event real-user traction/First-100/conversion remains NOT VERIFIED; broader Android/iPhone device matrix remains open. |

Canonical detail for earlier OPPO results lives in `PUBLIC-FORM-PHYSICAL-EVIDENCE.md`, `REAL-PLATFORM-UX-EVIDENCE.md`, `AUTH-INTERACTION-PHYSICAL-EVIDENCE.md`, `NF07-PHYSICAL-UPGRADE-EVIDENCE.md`, `PWA-UPGRADE-PHYSICAL-EVIDENCE.md`, `PRODUCT-EVENT-PHYSICAL-EVIDENCE.md` and `REFERRAL-SUMMARY-PHYSICAL-EVIDENCE.md`. Issue #551 and Issue #552 are the canonical defect records for the 2026-09-07 FAILs until post-deployment physical retest evidence advances them.
