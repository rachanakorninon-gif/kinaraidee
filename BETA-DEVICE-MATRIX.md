...
- Current browser/PWA runtime candidate: PR #548 / Home V3 / `6eac2ce642a907414260518d0435263b3e54f425` — `kinaraidee-beta-v16`; deployment status is **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE**; Runtime merge/deployed SHA is `46136f5ca6322847545289c18233320139147aa2`.
- Verified current deployment evidence: **PASS** for exact Home V3 merged-main SHA `46136f5ca6322847545289c18233320139147aa2`; Pages `34087987096`, main Live Smoke `34088055637`, Auth Password Security Live Smoke `34088055663`, and Campaign 3000 Premium Live Smoke `34088055657` = SUCCESS. This is deployment evidence only and does not create Home V3 physical acceptance, Issue #524/#545 physical PASS, Public Beta completion, user preference, conversion improvement or Commercial GO. Issues #524/#545 physical verification remain **PENDING / NOT PASS / NOT FAIL** for their affected scopes. Physical verification of the historical PR #537 password-recovery initialization fix also remains **PENDING** because a fresh recovery-email request was blocked by Supabase Auth `429 / over_email_send_rate_limit`; that block is not classified as a recovery regression PASS or FAIL.
- Historical Nearby remediation runtime: PR #546 / `e0523e6cab49b09e910ba66f2ad18351f491d19a`; verified deployed descendant `a6db511e0bbd6be9038bbc63a06fb5e1702006d3` with Pages `34013867862`, main Live Smoke `34013888880`, and Auth Password Security Live Smoke `34013888842`. This trace remains historical and is not current Home V3 physical evidence.
