...
- Current browser/PWA runtime candidate: Home V3 / `6eac2ce642a907414260518d0435263b3e54f425` — `kinaraidee-beta-v16`; deployment status is **PENDING FOR CURRENT RUNTIME DEPLOYMENT** and no current deployed SHA is claimed for this candidate.
- Verified current deployment evidence: **PENDING for Home V3**; no current Home V3 deployed SHA or deployment PASS is claimed. The last verified deployed browser/PWA descendant remains `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`; Pages `34013867862`, main Live Smoke `34013888880`, and Auth Password Security Live Smoke `34013888842` = SUCCESS on that historical Nearby runtime. Those runs are retained only as historical/last-verified deployment evidence and are not reused as Home V3 deployment PASS. Issues #524/#545 physical verification remain **PENDING / NOT PASS / NOT FAIL** for their affected scopes; deployment/live-smoke evidence does not replace physical acceptance. Physical verification of the historical PR #537 password-recovery initialization fix also remains **PENDING** because a fresh recovery-email request was blocked by Supabase Auth `429 / over_email_send_rate_limit`; that block is not classified as a recovery regression PASS or FAIL.
- Historical Nearby remediation runtime: PR #546 / `e0523e6cab49b09e910ba66f2ad18351f491d19a`; verified deployed descendant `a6db511e0bbd6be9038bbc63a06fb5e1702006d3` with Pages `34013867862`, main Live Smoke `34013888880`, and Auth Password Security Live Smoke `34013888842`. This trace is not current Home V3 deployment evidence.
- Historical PR #520 referral-summary Edge-only runtime: source `4e2e1789921aa6fd73b2677ac5def2bc35a8be73`; deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d`; Pages `33898258213` and main Live Smoke `33898314400` = SUCCESS. After the recorded scoped signed-in physical `EDGE` acceptance, the Member referral-summary browser path became Edge-only through JWT-verified `member-referral-api`; the temporary caller-scoped RPC fallback was removed and the later RPC execute revocation was separately verified. This historical deployment/security/physical evidence does not replace current Home V3 or create referral conversion, Campaign 3,000 eligibility, user-count growth or revenue evidence.
...
- Current Home V3 runtime candidate `6eac2ce642a907414260518d0435263b3e54f425` remains **PENDING FOR CURRENT RUNTIME DEPLOYMENT**. The last verified deployed descendant `a6db511e0bbd6be9038bbc63a06fb5e1702006d3` and its Pages/Live Smoke/Auth smoke runs belong to historical PR #546 and are not reused as Home V3 PASS. Issues #524/#545 remain **PENDING / NOT PASS / NOT FAIL** for physical post-remediation acceptance, and the historical PR #537 password-recovery initialization physical re-test remains PENDING because recovery-email issuance was rate-limited. Historical PR #520 referral-summary signed-in `EDGE` interaction and post-cutover RPC execute revocation/Advisor recheck retain their scoped evidence. Historical PR #509 Product Event deployment/controlled-ingress evidence remains scoped; separate OPPO Product Event physical QA PASS is not real-user traction. Historical PR #499 referral/acquisition deployment/schema/privacy-fix evidence remains scoped and no referred-signup/referral-conversion PASS is inferred.
