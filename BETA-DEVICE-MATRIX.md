...
- Current browser/PWA runtime candidate: PR #537 / `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72` — `kinaraidee-beta-v16`; current merged/deployed descendant SHA `d7dd3a550b9a0d583cd7f3269a357b0187377d50`.
- Verified current deployment evidence: Pages `33975327442` = SUCCESS on exact descendant `d7dd3a550b9a0d583cd7f3269a357b0187377d50`, main Live Smoke `33975353656` = SUCCESS on the same deployed SHA, and Auth Password Security Live Smoke `33975353718` = SUCCESS. Physical verification of the password-recovery initialization fix remains **PENDING** because a fresh recovery-email request was blocked by Supabase Auth `429 / over_email_send_rate_limit`; that block is not classified as a recovery regression PASS or FAIL.
- Historical PR #520 referral-summary Edge-only runtime: source `4e2e1789921aa6fd73b2677ac5def2bc35a8be73`; deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d`; Pages `33898258213` and main Live Smoke `33898314400` = SUCCESS. After the recorded scoped signed-in physical `EDGE` acceptance, the Member referral-summary browser path became Edge-only through JWT-verified `member-referral-api`; the temporary caller-scoped RPC fallback was removed and the later RPC execute revocation was separately verified. This historical deployment/security/physical evidence does not replace current PR #537 or create referral conversion, Campaign 3,000 eligibility, user-count growth or revenue evidence.
