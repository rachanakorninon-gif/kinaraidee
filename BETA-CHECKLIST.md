...
- [x] Current browser/PWA runtime candidate: `0b6352af081f51ad9df2343022d0683b109d93a4` (Issue #585 offline/PWA app-shell parity follow-up); deployment status is **PENDING FOR CURRENT RUNTIME DEPLOYMENT** and Runtime merge/deployed SHA remains **PENDING**. The last verified deployed browser/PWA descendant is `11c27167965c63ba60218d6ec216e503b334b4ca` from the prior Issue #585 toast runtime; GitHub Pages `34571331729`, main Live Smoke `34571373301`, Auth Password Security Live Smoke `34571373282`, Campaign 3000 Premium Live Smoke `34571373303`, and Premium Research Preview Live Smoke `34571373350` completed successfully on that exact deployed SHA. The PWA cache marker remains `kinaraidee-beta-v16`. Prior verified deployment evidence remains historical and is not reused as current PASS. Source/CI completion for the offline-shell candidate does not establish its deployment, VoiceOver/TalkBack/keyboard Physical PASS, another-device PASS, Public Beta completion, conversion improvement, Privacy/Legal approval or Commercial GO. Issues #592/#593 retain separate fresh **Physical PASS / CLOSED** evidence from the 2026-09-10 affected OPPO installed-PWA regression; Issues #524/#545 remain **PENDING / NOT PASS / NOT FAIL** for their affected iPhone scopes.
- [x] Historical PR #596 OPPO/PWA remediation deployment remains scoped evidence: source `de18711695bb94617c3cffa7767cb3943c0d2c05`, deployed descendant `ca6a1c1bcb622ff241101a9c40aabfcd2a4b9793`, Pages `34382130901`, main Live Smoke `34382207087`, Auth Password Security Live Smoke `34382207152`, and Campaign 3000 Premium Live Smoke `34382207209` = SUCCESS. Issues #592/#593 have separate scoped Physical PASS and this historical deployment does not replace current Issue #585 assistive-technology acceptance.
- [x] Historical PR #554 OPPO remediation deployment remains scoped evidence: source `6f7d56f0b68551c731d88d69e34286a8f2ecca70`, deployed descendant `0f96414295f2a5f5abd7da346aa8a58d47c10f63`, Pages `34137902178`, main Live Smoke `34137949343`, Auth Password Security Live Smoke `34137949293`, and Campaign 3000 Premium Live Smoke `34137949307` = SUCCESS. It is superseded as current runtime lineage and does not replace fresh Physical acceptance.
- [x] Historical Nearby remediation runtime candidate = PR #546 source `e0523e6cab49b09e910ba66f2ad18351f491d19a`; browser/PWA deployment trace verified on merged-main SHA `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`, Pages `34013867862`, main Live Smoke `34013888880`, and Auth Password Security Live Smoke `34013888842`. This historical deployment evidence does **not** mark the affected Maps-fallback or location-deny physical paths PASS: Issue #524 and Issue #545 remain **PENDING / NOT PASS / NOT FAIL** until their affected iPhone deployed physical retests exist.
- [x] Historical password-recovery runtime candidate = PR #537 source `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72`; historical browser/PWA deployment trace was verified on merged-main descendant `d7dd3a550b9a0d583cd7f3269a357b0187377d50`, Pages `33975327442`, main Live Smoke `33975353656`, and Auth Password Security Live Smoke `33975353718`. The physical re-test of the initialization fix remains **PENDING** because Supabase Auth blocked fresh recovery-email issuance with `429 / over_email_send_rate_limit`; this is not classified as a physical recovery PASS or FAIL and does not replace current Issue #585.
- [x] Historical PR #520 referral-summary Edge-only runtime remains scoped deployed evidence: source `4e2e1789921aa6fd73b2677ac5def2bc35a8be73`, deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d`, Pages `33898258213`, main Live Smoke `33898314400`, with separate scoped signed-in physical `EDGE` acceptance and post-cutover RPC privilege verification. It does not replace current Issue #585 and does not prove referral conversion, campaign eligibility, user-count increase or revenue.
...
- [x] Supabase referral/acquisition schema/RPC migration `20260903220832 / referral_acquisition_v1` และ referral-code privacy fix `20260903221043 / referral_code_privacy_fix_20260904` ถูก deploy แล้ว; post-fix read-only verification พบ referral rows = 0 และ attribution rows = 0 และ referral identifiers ใช้ random code ไม่ derive จาก account UUID. `member-referral-api` ACTIVE v1 ใช้ `verify_jwt=true`; missing/malformed-JWT rejection-only smoke ผ่าน และ signed-in Edge retrieval/render มี scoped physical PASS แยกตาม `REFERRAL-SUMMARY-PHYSICAL-EVIDENCE.md`. Backend/physical evidence นี้ไม่ใช่ referral-success หรือ Campaign 3,000 PASS.
- [x] Referral-summary post-cutover security follow-up เสร็จตามลำดับ: Edge-only runtime deploy/live-smoke ผ่านก่อน แล้วจึง apply `referral_summary_edge_cutover_revoke_rpc_20260904`; `get_my_referral_summary()` มี `anon_execute=false` และ `authenticated_execute=false`, raw referral tables ไม่มี browser-role grants และ Supabase Advisor ไม่รายงาน authenticated-callable SECURITY DEFINER warning เดิมแล้ว.
- [ ] Supabase leaked-password protection ยังไม่ได้เปิด; Auth UX/runtime evidence ไม่แทน server-side rejection — Issue #372

## Verified browser/PWA deployment evidence — historical scope before current Issue #585 candidate
- [x] Prior current referral-summary Edge-only runtime = PR #520 / `4e2e1789921aa6fd73b2677ac5def2bc35a8be73`; historical deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d`, Pages `33898258213`, main Live Smoke `33898314400` = SUCCESS. Its scoped physical `EDGE` and security cutover evidence remains valid but does not replace current Issue #585.
- [x] Prior referral-summary pre-cutover runtime candidate = PR #514 / `ea409cd02fc7744514b8c867a67f56ec0187de80`; historical deployed descendant `adbb23c4f373ebfe6ed1d78e71ec051a3c05ed7a`, Pages `33838629999`, main Live Smoke `33838665915` = SUCCESS. This historical trace included the temporary RPC fallback.
...
หลักฐาน deployment/synthetic เหล่านี้ไม่ใช่ real-device, accessibility, payment, legal, partner หรือ Commercial PASS และไม่ใช่หลักฐานที่ใช้ปิด real Feedback/Partner, Auth interaction, referral conversion หรือ Product Event interaction. Referral-summary มี scoped signed-in physical `EDGE` PASS และ post-cutover security follow-up ที่บันทึกแยกแล้ว ขณะที่ weak/leaked-password rejection ยัง OPEN และ Product Event มีเพียง scoped OPPO physical QA PASS ไม่ใช่ real-user traction หรือ full-matrix PASS
...
- [x] OPPO Reno13 5G / Android 16 / Chrome 152.0.7977.64: NF-07 scoped physical v15 → v16 PASS on 2026-09-05; verified historical-v15 baseline → physical close → 1 normal online reopen → v16 verifier → Home + Surprise usable; ไม่ใช่ full-matrix/Public-Beta PASS
...
- [x] OPPO Reno13 5G / Android 16 / Chrome 152.0.7977.64: referral-summary signed-in scoped physical `EDGE` PASS on 2026-09-04; summary rendered, aggregate fields rendered as numbers and Share/Copy controls became enabled. Canonical record is `REFERRAL-SUMMARY-PHYSICAL-EVIDENCE.md`; no numeric aggregates, referral/account identifiers or tokens were retained. The later Edge-only deployment/RPC revocation is separately verified and this does not prove referral conversion.
- [x] OPPO Reno13 5G / Android 16 / installed standalone PWA, 2026-09-07: TC-02, TC-09, TC-10, TC-13, TC-14, NF-01, NF-02, NF-08 and NF-10 scoped physical PASS. Issue #551 Home bottom-navigation path has a scoped **Physical PASS / CLOSED** on this affected device scope.
- [x] OPPO Reno13 5G / Android 16 / installed standalone PWA, 2026-09-08 continuation: Issue #552 / TC-03 fresh affected-device retest **Physical PASS / CLOSED** (`แกงฮังเล`, `ต้มข่าไก่`, `คิมชีจีแก`); TC-08 fresh Location Allow **Physical PASS** after fresh permission prompt/grant + successful retry acquisition; TC-10 Maps fallback revalidated through nearby search/result/directions; fresh Favorite and accepted-meal History survived full Recent Apps close/reopen; local 2-person Group flow passed per-member state isolation, score/result, reroll with preserved score, History handoff, Android Share Sheet opening/cancel recovery and clean Home recovery after full restart. Canonical record: `OPPO-PHYSICAL-QA-EVIDENCE-20260908.md`.
- [x] OPPO Reno13 5G / Android 16 / installed standalone PWA, 2026-09-10 affected-device continuation: Issues #592/#593 fresh post-PR #596 regression **Physical PASS / CLOSED**; Preference `🎲 ไม่รู้เลย — เลือกให้ฉัน` reached Result with one tap, Nearby Location success cleared stale loading copy and returned the Location button to normal while Google Maps fallback remained usable. The same session records scoped TC-05 History acceptance for accepted `ยำไข่ต้ม` and TC-06 Favorite acceptance for newly favorited `บะหมี่หมูแดง`; these observations do not complete the device matrix.
- [ ] PR #499 referral/acquisition real-device signup/attribution acceptance; deployment/schema evidence above does not substitute for an actual referred signup/attribution test.

ขอบเขต: หลักฐานข้างต้นเป็น scoped physical sessions; exact model/OS/browser metadata บาง historical รายการไม่ได้ถูกบันทึกและห้ามเดา ห้ามขยาย scoped OPPO TC-03/TC-05/TC-06/TC-08/TC-09/TC-10/History/Group/TC-11/TC-12/Auth/Reduced-Motion/NF-07/Product-Event/referral-summary/#592/#593 PASS หรือ scoped Lenovo Keyboard Focus PASS ไปเป็น PASS ของรุ่นอื่น, referred-signup/referral-conversion, full device matrix, blanket Auth/Security PASS, real-user acquisition traction หรือ Commercial GO
...
- [x] TC-08 Location allow มี scoped physical iPhone/Safari #1 PASS บน v16 และ scoped OPPO Reno13 5G fresh-permission PASS บน 2026-09-08; ยังไม่ใช่ full-matrix PASS
...
- [x] Referral-summary signed-in `EDGE` retrieval/render ผ่าน real deployed browser/device interaction — scoped OPPO Reno13 5G / Android 16 / Chrome 152.0.7977.64 ตาม `REFERRAL-SUMMARY-PHYSICAL-EVIDENCE.md`; ไม่ใช่ referred-signup/referral-conversion/full-matrix PASS
- [ ] PR #537 deployed password-recovery initialization fix physical re-test — currently PENDING because fresh recovery-email issuance was blocked by Supabase Auth `429 / over_email_send_rate_limit`; resume only after the email-send limit clears.
...
- [x] Group API source candidate PR #518 deploy เป็น Supabase ACTIVE version 7, ตรวจ source/deployment parity และ scoped privacy-safe rejection-event ingestion แล้ว
...
- [x] Group API application structured-event ingestion — scoped application-owned privacy-safe rejection-event presence ingestion verified on production v7; real monitoring baseline / owner-alert-escalation path ยัง OPEN — Issue #45
