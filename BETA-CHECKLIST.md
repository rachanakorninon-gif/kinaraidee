...
- [x] Current browser/PWA runtime candidate: `0b6352af081f51ad9df2343022d0683b109d93a4` (Issue #585 offline/PWA app-shell parity follow-up merged through PR #627); deployment status is **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE** and Runtime merge/deployed SHA is `af329c471c0335fd6e0812a8d5f75066ffb335cd`. GitHub Pages `34676035335`, Toast Accessibility Live Smoke `34676056553`, main Live Smoke `34676056521`, Auth Password Security Live Smoke `34676056466`, Campaign 3000 Premium Live Smoke `34676056536`, and Premium Research Preview Live Smoke `34676056518` completed successfully on that exact deployed SHA. The PWA cache marker remains `kinaraidee-beta-v16`. This deployment PASS establishes that `data/toast-accessibility.js` is present in the Service Worker app shell but does not establish VoiceOver/TalkBack/keyboard Physical PASS, another-device PASS, Public Beta completion, conversion improvement, Privacy/Legal approval or Commercial GO. Issues #592/#593 retain separate fresh **Physical PASS / CLOSED** evidence from the 2026-09-10 affected OPPO installed-PWA regression; Issues #524/#545 remain **PENDING / NOT PASS / NOT FAIL** for their affected iPhone scopes.
