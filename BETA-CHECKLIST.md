...
- [ ] Current Home V3 runtime candidate = `6eac2ce642a907414260518d0435263b3e54f425`; deployment status is **PENDING FOR CURRENT RUNTIME DEPLOYMENT**. No current deployed SHA is claimed for this candidate. The last verified deployed browser/PWA descendant remains `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`, with GitHub Pages `34013867862`, main Live Smoke `34013888880`, and Auth Password Security Live Smoke `34013888842`. Those runs belong to the prior Nearby runtime and are retained only as historical/last-verified evidence, not as Home V3 deployment PASS.
