...
ขอบเขต: หลักฐานข้างต้นเป็น scoped physical sessions; exact model/OS/browser metadata บาง historical รายการไม่ได้ถูกบันทึกและห้ามเดา ห้ามขยาย scoped OPPO TC-11/TC-12/Auth/Reduced-Motion PASS ไปเป็น PASS ของ referral-summary flow, Product Event flow, รุ่นอื่น, full device matrix, blanket Auth/Security PASS หรือ Commercial GO
