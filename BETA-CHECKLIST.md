...
- [x] Current browser/PWA runtime candidate: `de18711695bb94617c3cffa7767cb3943c0d2c05` (PR #596 OPPO Preference Surprise + Nearby terminal-status remediation); deployment status is **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE**. Runtime merge/deployed SHA = `ca6a1c1bcb622ff241101a9c40aabfcd2a4b9793`; GitHub Pages `34382130901`, main Live Smoke `34382207087`, Auth Password Security Live Smoke `34382207152`, and Campaign 3000 Premium Live Smoke `34382207209` completed successfully for the exact deployed SHA. This deployment PASS is scoped to the browser/PWA static deployment trace and live source markers only; it does not by itself establish Physical PASS, Public Beta completion, conversion improvement, Privacy/Legal approval or Commercial GO. Issues #592/#593 have separate fresh **Physical PASS / CLOSED** evidence from the 2026-09-10 affected OPPO installed-PWA regression. Issue #551 and Issue #552 / TC-03 retain their earlier scoped **Physical PASS / CLOSED** evidence, and TC-08 allow retains scoped **Physical PASS** from the 2026-09-08 fresh-permission OPPO retest.
...
- [x] Historical password-recovery runtime candidate = PR #537 source `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72`; historical browser/PWA deployment trace was verified on merged-main descendant `d7dd3a550b9a0d583cd7f3269a357b0187377d50`, Pages `33975327442`, main Live Smoke `33975353656`, and Auth Password Security Live Smoke `33975353718`. The physical re-test of the initialization fix remains **PENDING** because Supabase Auth blocked fresh recovery-email issuance with `429 / over_email_send_rate_limit`; this is not classified as a physical recovery PASS or FAIL and does not replace current PR #596.
- [x] Historical PR #520 referral-summary Edge-only runtime remains scoped deployed evidence: source `4e2e1789921aa6fd73b2677ac5def2bc35a8be73`, deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d`, Pages `33898258213`, main Live Smoke `33898314400`, with separate scoped signed-in physical `EDGE` acceptance and post-cutover RPC privilege verification. It does not replace current PR #596 and does not prove referral conversion, campaign eligibility, user-count increase or revenue.
...
## Verified browser/PWA deployment evidence — historical scope before current PR #596 candidate
- [x] Prior current referral-summary Edge-only runtime = PR #520 / `4e2e1789921aa6fd73b2677ac5def2bc35a8be73`; historical deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d`, Pages `33898258213`, main Live Smoke `33898314400` = SUCCESS. Its scoped physical `EDGE` and security cutover evidence remains valid but does not replace current PR #596.
