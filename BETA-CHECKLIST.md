...
- [x] Current referral-summary runtime candidate = PR #520 source `4e2e1789921aa6fd73b2677ac5def2bc35a8be73`; browser/PWA deployment trace verified on merged-main descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d`, Pages `33898258213`, and main Live Smoke `33898314400`. หลัง scoped signed-in physical `EDGE` acceptance บน OPPO ที่บันทึกไว้แล้ว `member.html` ใช้ JWT-verified `member-referral-api` เป็น browser path เดียวและถอด temporary `get_my_referral_summary()` RPC fallback แล้ว. Deployment PASS นี้ยังไม่ใช่ referral conversion, campaign eligibility, user-count increase หรือ revenue PASS.
...
## Verified browser/PWA deployment evidence — historical scope before current PR #520
- [x] Prior referral-summary pre-cutover runtime candidate = PR #514 / `ea409cd02fc7744514b8c867a67f56ec0187de80`; historical deployed descendant `adbb23c4f373ebfe6ed1d78e71ec051a3c05ed7a`, Pages `33838629999`, main Live Smoke `33838665915` = SUCCESS. This historical trace included the temporary RPC fallback and is not the current Edge-only runtime.
