...
- [x] Current browser/PWA runtime candidate: `d24824948c9df1808178b9bb5a78a8f885086fb4` (canonical merged-main Home V3 contrast runtime retaining the TC-03 classification fix); deployment status is **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE**. Runtime merge/deployed SHA = `f6b8598597edd874e69cbfe1dae941c919aaa037`; GitHub Pages `34161708724` and main Live Smoke `34161744258` = SUCCESS for that exact deployed SHA. This deployment PASS is scoped to the browser/PWA static deployment trace and live source markers only; it does not by itself establish Physical PASS, Public Beta completion, conversion improvement, Privacy/Legal approval or Commercial GO. Issue #551 has a separate scoped Physical PASS/CLOSED on the affected OPPO Home-nav path. Issue #552 / TC-03 now also has scoped **Physical PASS / CLOSED** after the fresh 2026-09-08 affected-device OPPO retest, and TC-08 allow now has scoped **Physical PASS** after a fresh permission prompt/grant and successful Location acquisition retry were physically captured.
...
- [x] Historical password-recovery runtime candidate = PR #537 source `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72`; historical browser/PWA deployment trace was verified on merged-main descendant `d7dd3a550b9a0d583cd7f3269a357b0187377d50`, Pages `33975327442`, main Live Smoke `33975353656`, and Auth Password Security Live Smoke `33975353718`. The physical re-test of the initialization fix remains **PENDING** because Supabase Auth blocked fresh recovery-email issuance with `429 / over_email_send_rate_limit`; this is not classified as a physical recovery PASS or FAIL and does not replace current Home V3.
- [x] Historical PR #520 referral-summary Edge-only runtime remains scoped deployed evidence: source `4e2e1789921aa6fd73b2677ac5def2bc35a8be73`, deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d`, Pages `33898258213`, main Live Smoke `33898314400`, with separate scoped signed-in physical `EDGE` acceptance and post-cutover RPC privilege verification. It does not replace current Home V3 and does not prove referral conversion, campaign eligibility, user-count increase or revenue.
...
## Verified browser/PWA deployment evidence — historical scope before current Home V3 candidate
- [x] Prior current referral-summary Edge-only runtime = PR #520 / `4e2e1789921aa6fd73b2677ac5def2bc35a8be73`; historical deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d`, Pages `33898258213`, main Live Smoke `33898314400` = SUCCESS. Its scoped physical `EDGE` and security cutover evidence remains valid but does not replace current Home V3.
...
ขอบเขต: หลักฐานข้างต้นเป็น scoped physical sessions; exact model/OS/browser metadata บาง historical รายการไม่ได้ถูกบันทึกและห้ามเดา ห้ามขยาย scoped OPPO TC-03/TC-08/TC-09/TC-10/History/Group/TC-11/TC-12/Auth/Reduced-Motion/NF-07/Product-Event/referral-summary PASS หรือ scoped Lenovo Keyboard Focus PASS ไปเป็น PASS ของรุ่นอื่น, referred-signup/referral-conversion, full device matrix, blanket Auth/Security PASS, real-user acquisition traction หรือ Commercial GO
