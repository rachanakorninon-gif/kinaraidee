...
- [x] Product Event Measurement runtime candidate = PR #509 source `0bd5acfb9946e10ed5624205165123eabc8035b4`; browser/PWA deployment trace verified on merged-main descendant `75f95dd95b0b480f3cf3ebb668d62f7cb45345ba`, Pages `33823701475`, and main Live Smoke `33823746430`. Product Event API Live Smoke `33824058988` passed a controlled production-ingress probe from a GitHub-hosted runner; its exact synthetic `landing` row was deleted after evidence capture and a follow-up query confirmed 0 matching rows remain. This is deployment/source/controlled-ingress evidence only and does not establish a real Product Funnel interaction, referral signup, campaign eligibility, user-count increase, conversion or revenue.
...
## Verified browser/PWA deployment evidence — historical scope before PR #509
...
- [ ] PR #509 Product Event Measurement real-device interaction acceptance; Pages/Live Smoke and controlled production API smoke do not substitute for an actual user/device Product Funnel run.

ขอบเขต: หลักฐานข้างต้นเป็น scoped physical sessions; exact model/OS/browser metadata บาง historical รายการไม่ได้ถูกบันทึกและห้ามเดา ห้ามขยาย scoped OPPO TC-11/TC-12/Auth/Reduced-Motion PASS ไปเป็น PASS ของ referral flow, Product Event flow, รุ่นอื่น, full device matrix, blanket Auth/Security PASS หรือ Commercial GO
