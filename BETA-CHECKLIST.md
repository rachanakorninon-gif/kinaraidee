...
- [x] Current OPPO remediation runtime candidate = PR #554 / `6f7d56f0b68551c731d88d69e34286a8f2ecca70`; deployment status is **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE**. Runtime merge/deployed SHA = `0f96414295f2a5f5abd7da346aa8a58d47c10f63`; GitHub Pages `34137902178`, main Live Smoke `34137949343`, Auth Password Security Live Smoke `34137949293`, and Campaign 3000 Premium Live Smoke `34137949307` = SUCCESS for that exact deployed SHA. This deployment PASS is scoped to the browser/PWA static deployment trace and live source markers only; it does not establish Issue #551 Home visual Physical PASS, Issue #552 / TC-03 Physical PASS, TC-08 PASS, Public Beta completion, conversion improvement, Privacy/Legal approval or Commercial GO. Issues #551/#552 remain **FAIL / OPEN** pending affected-device OPPO retest, and TC-08 allow from the 2026-09-07 OPPO session remains **INCONCLUSIVE** because a fresh permission-grant prompt/state was not captured.
...
- [x] OPPO Reno13 5G / Android 16 / installed standalone PWA, 2026-09-07: TC-02, TC-09, TC-10, TC-13, TC-14, NF-01, NF-02, NF-08 and NF-10 scoped physical PASS. TC-08 allow remains **INCONCLUSIVE** because a fresh permission-grant prompt/state was not captured. Issue #551 Home bottom-navigation clipping and Issue #552 / TC-03 soup-preference mismatch remain **FAIL / OPEN** until the deployed PR #554 remediation is physically retested on this affected device scope.
