...
- Current browser/PWA runtime candidate: `6eac2ce642a907414260518d0435263b3e54f425` (PR #548 Home V3 presentation lineage).
...
PR #548 carries the current Home V3 presentation lineage. The source candidate `6eac2ce642a907414260518d0435263b3e54f425` merged through protected `main` as `46136f5ca6322847545289c18233320139147aa2`; Pages, main Live Smoke, Auth Password Security Live Smoke and Campaign 3000 Premium Live Smoke traces succeeded for that exact deployed SHA. This deployment evidence is scoped to the browser/PWA deployment trace only. Physical verification of inherited Issues #524 and #545 remains **PENDING / NOT PASS / NOT FAIL** and deployment/live-smoke evidence must not be promoted to TC-08/TC-09 or Home V3 physical acceptance.
...
- PR #548 source runtime candidate is `6eac2ce642a907414260518d0435263b3e54f425`.
- PR #548 merged to main as descendant `46136f5ca6322847545289c18233320139147aa2`.
- GitHub Pages run `34087987096` completed **success** for exact merged-main SHA `46136f5ca6322847545289c18233320139147aa2`.
- Main Live Smoke run `34088055637` completed **success** for the same deployed SHA.
- Auth Password Security Live Smoke run `34088055663` completed **success** for the same deployed SHA.
- Campaign 3000 Premium Live Smoke run `34088055657` completed **success** for the same deployed SHA.
- Current deployment PASS is scoped to the browser/PWA static deployment trace and live source markers only. It does **not** establish Home V3 physical acceptance, physical acceptance of Issues #524/#545, TC-08/TC-09 completion, Public Beta completion, Privacy/Legal approval or Commercial GO. Issues #524/#545 remain **PENDING / NOT PASS / NOT FAIL**.
...
- Nearby physical verification for Issues #524/#545 remains **PENDING / NOT PASS / NOT FAIL** for the affected scopes. The verified Home V3 deployment inherits the Nearby remediation source but deployment/live-smoke evidence does not replace the required real-device Maps fallback and location-deny retests.
...
- Current browser/PWA runtime candidate = PR #548 Home V3 source runtime `6eac2ce642a907414260518d0435263b3e54f425`; deployment status = **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE**; deployed descendant = `46136f5ca6322847545289c18233320139147aa2`.
...
- PR #546 / `e0523e6cab49b09e910ba66f2ad18351f491d19a` with deployed descendant `a6db511e0bbd6be9038bbc63a06fb5e1702006d3` remains historical verified Nearby browser/PWA deployment evidence and does not replace the current Home V3 runtime; Issues #524/#545 remain physically pending.
- PR #537 / `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72` with deployed descendant `d7dd3a550b9a0d583cd7f3269a357b0187377d50` remains historical verified password-recovery browser/PWA deployment evidence and does not replace the current Home V3 runtime; its physical retest remains pending.
- PR #520 / `4e2e1789921aa6fd73b2677ac5def2bc35a8be73` with deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d` remains historical verified Edge-only referral-summary browser/PWA deployment evidence and does not replace the current Home V3 runtime.
- PR #514 / `ea409cd02fc7744514b8c867a67f56ec0187de80` with deployed descendant `adbb23c4f373ebfe6ed1d78e71ec051a3c05ed7a` remains historical verified pre-cutover referral-summary browser/PWA deployment evidence and does not replace the current Home V3 runtime.
- PR #509 / `0bd5acfb9946e10ed5624205165123eabc8035b4` with deployed descendant `75f95dd95b0b480f3cf3ebb668d62f7cb45345ba` remains historical verified Product Event browser/PWA deployment evidence and does not replace the current Home V3 runtime. The later scoped physical Product Event QA PASS is independent of this deployment evidence and is not real-user traction.
- PR #499 / `f401ad758e40914a10245cfab08497f7cdb99f7d` with deployed descendant `02540bb61c3c62de4cfba34e92a876503765847d` remains historical verified referral/acquisition browser/PWA deployment evidence and does not replace the current Home V3 runtime or create referral conversion acceptance.
- PR #373 / `6cd98bf2a2020b86fe2ab05e263dd59f7e4fb387` with deployed descendant `0cc3ec3ef4dda18f0d8e083d8ca0992ef77f844c` remains historical verified Auth browser/PWA deployment evidence and does not replace the current Home V3 runtime or create referral/Product Event acceptance.
- PR #201 / `00bdcb7f432598e2eb82e71dcf1a9ec804ff1c4b2` remains historical verified browser/PWA deployment evidence for the public-form resilience runtime and does not replace current Home V3 deployment evidence.
