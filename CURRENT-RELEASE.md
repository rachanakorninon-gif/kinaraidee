...
- This deployment PASS proves browser/PWA source/deployment lineage and live source markers only. It does not by itself prove a successful signed-in referral-summary `EDGE` response, referral conversion, Product Event physical interaction, Campaign 3,000 eligibility, user-count increase, paid-ad conversion or revenue. The separate scoped Product Event physical QA PASS is recorded independently in `PRODUCT-EVENT-PHYSICAL-EVIDENCE.md`.
...
Current deployment PASS is scoped to exact runtime lineage and checks identified above. It does **not by itself** establish Product Event physical interaction, referral interaction acceptance, weak/leaked-password rejection or any new real-device account-flow acceptance. Separate physical evidence records scoped Product Event QA, recovery/password-update/sign-in/new-signup/email-confirmation and other behavior-specific passes; those results remain documented independently and must not be generalized.
...
- PR #509 / `0bd5acfb9946e10ed5624205165123eabc8035b4` with deployed descendant `75f95dd95b0b480f3cf3ebb668d62f7cb45345ba` remains historical verified Product Event browser/PWA deployment evidence and does not replace current PR #514 runtime. The later scoped physical Product Event QA PASS is independent of this deployment evidence and is not real-user traction.
