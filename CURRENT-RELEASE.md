...
- Reduced Motion / Issue #133 is **PASS for the tested physical iPhone device/session #1 Surprise flow on deployed v16 lineage (2026-08-31)** with Reduce Motion enabled. Exact iPhone model, iOS and Safari/PWA versions were not captured and are not guessed. This scoped PASS does not establish keyboard-focus acceptance, Android reduced-motion coverage, second-iPhone coverage, NF-07, full real-device acceptance or Public Beta completion.
...
- Physical iPhone/VoiceOver evidence closes NF-09 only for the tested session; scoped physical iPhone Reduced Motion evidence closes only the tested iPhone #1 Surprise-flow reduced-motion acceptance. Neither closes NF-07, second-device requirements, Android reduced-motion coverage, real form-submission acceptance, current Auth interaction acceptance, keyboard-focus checks or the remaining full-device-matrix gates.