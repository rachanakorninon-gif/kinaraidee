...
- Current browser/PWA runtime candidate: `e0523e6cab49b09e910ba66f2ad18351f491d19a` (PR #546 Nearby iOS remediation lineage).
...
PR #546 carries the current Nearby remediation lineage. The source candidate `e0523e6cab49b09e910ba66f2ad18351f491d19a` merged through protected `main` as `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`; Pages, main Live Smoke and Auth Password Security Live Smoke traces succeeded for that exact deployed SHA. Physical verification of Issues #524 and #545 remains **PENDING / NOT PASS / NOT FAIL** and deployment/live-smoke evidence must not be promoted to TC-08/TC-09 physical acceptance.
...
- PR #546 source runtime candidate is `e0523e6cab49b09e910ba66f2ad18351f491d19a`.
- PR #546 merged to main as descendant `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`.
- GitHub Pages run `34013867862` completed **success** for exact merged-main SHA `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`.
- Main Live Smoke run `34013888880` completed **success** for the same deployed SHA.
- Auth Password Security Live Smoke run `34013888842` completed **success** for the same deployed SHA.
- Current deployment PASS is scoped to the browser/PWA static deployment trace and live source markers only. It does **not** establish physical acceptance of Issues #524/#545, TC-08/TC-09 completion, Public Beta completion, Privacy/Legal approval or Commercial GO. Issues #524/#545 remain **PENDING / NOT PASS / NOT FAIL**.
...
- Nearby physical verification for Issues #524/#545 remains **PENDING / NOT PASS / NOT FAIL** for the affected scopes after deployment of PR #546. The deployment/live-smoke trace does not replace the required real-device Maps fallback and location-deny retests.
...
- Current browser/PWA runtime candidate = PR #546 source runtime `e0523e6cab49b09e910ba66f2ad18351f491d19a`; deployment status = **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE**; deployed descendant = `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`.
...
- PR #537 / `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72` with deployed descendant `d7dd3a550b9a0d583cd7f3269a357b0187377d50` remains historical verified password-recovery browser/PWA deployment evidence and does not replace current PR #546 runtime; its physical retest remains pending.
- PR #520 / `4e2e1789921aa6fd73b2677ac5def2bc35a8be73` with deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d` remains historical verified Edge-only referral-summary browser/PWA deployment evidence and does not replace current PR #546 runtime.
- PR #514 / `ea409cd02fc7744514b8c867a67f56ec0187de80` with deployed descendant `adbb23c4f373ebfe6ed1d78e71ec051a3c05ed7a` remains historical verified pre-cutover referral-summary browser/PWA deployment evidence and does not replace current PR #546 runtime.
- PR #509 / `0bd5acfb9946e10ed5624205165123eabc8035b4` with deployed descendant `75f95dd95b0b480f3cf3ebb668d62f7cb45345ba` remains historical verified Product Event browser/PWA deployment evidence and does not replace current PR #546 runtime. The later scoped physical Product Event QA PASS is independent of this deployment evidence and is not real-user traction.
- PR #499 / `f401ad758e40914a10245cfab08497f7cdb99f7d` with deployed descendant `02540bb61c3c62de4cfba34e92a876503765847d` remains historical verified referral/acquisition browser/PWA deployment evidence and does not replace current PR #546 runtime or create referral conversion acceptance.
...
- PR #201 / `00bdcb7f432598e2eb82e71dcf1a9ec804ff1c4b2` remains historical verified browser/PWA deployment evidence for the public-form resilience runtime and does not replace current PR #546 deployment evidence.
