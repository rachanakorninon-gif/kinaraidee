...
PR #537 fixes the password-recovery initialization race by requiring the recovery URL/session initialization promise to finish before the save action checks `sb.auth.getSession()`. The source candidate `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72` merged through protected `main` as `d7dd3a550b9a0d583cd7f3269a357b0187377d50`; its Pages, main Live Smoke and Auth Password Security Live Smoke traces succeeded. Physical verification of the fix remains **PENDING** because the deployed retest was blocked at recovery-email issuance by Supabase Auth `429 / over_email_send_rate_limit`. That rate-limit block is neither a physical PASS nor a regression FAIL for the initialization fix.
...
- PR #537 source runtime candidate is `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72`.
- PR #537 merged to main as descendant `d7dd3a550b9a0d583cd7f3269a357b0187377d50`.
- GitHub Pages run `33975327442` completed **success** for exact merged-main SHA `d7dd3a550b9a0d583cd7f3269a357b0187377d50`.
- Main Live Smoke run `33975353656` completed **success** for the same deployed SHA.
- Auth Password Security Live Smoke run `33975353718` completed **success** for the same deployed SHA.
- Current deployment PASS is scoped to the browser/PWA static deployment trace and live source markers only. It does **not** establish physical acceptance of the password-recovery initialization fix; that retest remains PENDING because recovery-email issuance hit the observed Supabase Auth rate limit.
...
- Password-recovery initialization fix physical verification is **PENDING** for the deployed PR #537 runtime. The observed post-deployment recovery requests were blocked before email issuance by Supabase Auth `429 / over_email_send_rate_limit`; this does not classify the initialization fix as physical PASS or FAIL.
...
- Current browser/PWA runtime candidate = PR #537 source runtime `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72`; deployment status = **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE**; deployed descendant = `d7dd3a550b9a0d583cd7f3269a357b0187377d50`.
...
- PR #520 / `4e2e1789921aa6fd73b2677ac5def2bc35a8be73` with deployed descendant `aa470986589d83dd95b4efd6e4a4d68a9f55965d` remains historical verified Edge-only referral-summary browser/PWA deployment evidence and does not replace current PR #537 runtime.
- PR #514 / `ea409cd02fc7744514b8c867a67f56ec0187de80` with deployed descendant `adbb23c4f373ebfe6ed1d78e71ec051a3c05ed7a` remains historical verified pre-cutover referral-summary browser/PWA deployment evidence and does not replace current PR #537 runtime.
- PR #509 / `0bd5acfb9946e10ed5624205165123eabc8035b4` with deployed descendant `75f95dd95b0b480f3cf3ebb668d62f7cb45345ba` remains historical verified Product Event browser/PWA deployment evidence and does not replace current PR #537 runtime. The later scoped physical Product Event QA PASS is independent of this deployment evidence and is not real-user traction.
- PR #499 / `f401ad758e40914a10245cfab08497f7cdb99f7d` with deployed descendant `02540bb61c3c62de4cfba34e92a876503765847d` remains historical verified referral/acquisition browser/PWA deployment evidence and does not replace current PR #537 runtime or create referral conversion acceptance.
...
- PR #201 / `00bdcb7f432598e2eb82e71dcf1a9ec804ff1c4b2` remains historical verified browser/PWA deployment evidence for the public-form resilience runtime and does not replace current PR #537 deployment evidence.
