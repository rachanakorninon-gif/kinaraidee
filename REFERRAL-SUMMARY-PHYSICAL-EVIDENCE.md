...
- Main `Kinaraidee Live Smoke Test` run `33838665915`: **success** after the same deployment.
...
Use a real signed-in Member session against deployed main descendant `adbb23c4f373ebfe6ed1d78e71ec051a3c05ed7a` or a later descendant that preserves the same `member.html` runtime without referral-path changes.
