...
- PR #509 adds privacy-minimal Product Event Measurement for reviewed UTM traffic while preserving the existing `kinaraidee-beta-v16` Service Worker generation. Product telemetry is best-effort unique-session measurement and does not establish identity, Campaign 3,000 eligibility, user growth, conversion or revenue.
- Current verified browser/PWA deployment trace: merged-main descendant `75f95dd95b0b480f3cf3ebb668d62f7cb45345ba`; Pages run `33823701475` and main Live Smoke `33823746430` completed success on the traced PR #509 deployment/source. Product Event API Live Smoke run `33824058988` separately verified controlled production ingestion from a GitHub-hosted runner; its exact synthetic `landing` row was deleted after evidence capture and a follow-up query confirmed 0 matching rows remain. This is deployment/source/controlled-ingress evidence only, not Product Event real-device acceptance.
...
- Historical PR #499 referral/acquisition runtime remains scoped deployment/acquisition evidence: source `f401ad758e40914a10245cfab08497f7cdb99f7d`, deployed descendant `02540bb61c3c62de4cfba34e92a876503765847d`, Pages `33811511793`, and Referral acquisition regression `33811512053`. This historical trace does not replace the current PR #509 runtime or establish a real referral interaction.
- Historical PR #373 Auth runtime remains scoped deployment/Auth evidence: source `6cd98bf2a2020b86fe2ab05e263dd59f7e4fb387`, deployed descendant `0cc3ec3ef4dda18f0d8e083d8ca0992ef77f844c`, Pages `33229525995`, Auth Password Security Live Smoke `33229548182`, and main Live Smoke `33229548190`. This historical trace does not replace the current PR #509 runtime.
...
- Current Auth account-flow evidence has scoped physical PASS on OPPO Reno13 5G / Android 16 / Chrome 152.0.7977.64 for recovery/password update/sign-in/new signup/email confirmation; leaked-password rejection remains NOT VERIFIED / blocked separately. This evidence is rooted in the PR #373 Auth flow but remains valid independently of PR #509 becoming the current browser runtime.
- Regression guards include Public Form Resilience, Surprise accessibility, Group Result, History Sync, PWA cache upgrade, NF-07 physical fixture boundary, iOS install hint, release consistency, runtime lineage, real-device contracts, Device UX, referral-acquisition, Product Event Measurement and Group API source-contract checks.
...
- [x] `CURRENT-RUNTIME.md` / `CURRENT-RELEASE.md` ระบุ current PR #509 runtime candidate และสถานะ **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE** สอดคล้องกัน
- [x] Current PR #509 Product Event Measurement runtime มี canonical descendant Pages deployment + corresponding live-check evidence ตาม release contract — deployed descendant `75f95dd95b0b480f3cf3ebb668d62f7cb45345ba`, Pages `33823701475`, main Live Smoke `33823746430`, Product Event API Live Smoke `33824058988`; synthetic probe row ถูก cleanup แล้วหลังเก็บ evidence
