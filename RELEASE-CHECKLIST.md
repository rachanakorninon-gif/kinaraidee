...
- Last verified deployed browser/PWA descendant: `11c27167965c63ba60218d6ec216e503b334b4ca`.
...
- Current browser/PWA deployment evidence is **PASS for the deployment trace only**: Issue #585 runtime candidate `f9b5f137375e9d30d1053d9cad814d636cb88821` is verified through exact deployed descendant `11c27167965c63ba60218d6ec216e503b334b4ca`; Pages run `34571331729`, Kinaraidee Live Smoke `34571373301`, Auth Password Security Live Smoke `34571373282`, and Campaign 3000 Premium Live Smoke `34571373303` completed successfully for the PR #623 trace. The cache remains `kinaraidee-beta-v16`. This deployment PASS does not itself establish VoiceOver/TalkBack/keyboard Physical PASS, another-device PASS, full accessibility conformance, Public Beta completion, Privacy/Legal approval or Commercial GO. Issues #592/#593 retain separate scoped **Physical PASS / CLOSED** from the fresh 2026-09-10 OPPO installed-PWA regression; Issues #524/#545 remain affected-iPhone physical PENDING. Historical Issue #583 / PR #602 deployment remains prior verified evidence only.
...
- Historical PR #520 is the post-acceptance referral-summary browser runtime. After a scoped signed-in physical session returned privacy-safe `EDGE` and satisfied the render acceptance checks, `member.html` removed the caller-scoped `get_my_referral_summary()` fallback and now uses JWT-verified `member-referral-api` as the only browser retrieval path. Optional QA trace exposes only `EDGE/UNAVAILABLE`. Its deployment/security/physical evidence remains scoped and does not replace current PR #623 runtime.
