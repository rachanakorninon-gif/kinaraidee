...
- Current browser/PWA runtime candidate: `6eac2ce642a907414260518d0435263b3e54f425` (Home V3 presentation runtime)
...
- Current Home V3 deployment evidence is **PASS for the browser/PWA deployment trace only**: exact merged-main SHA `46136f5ca6322847545289c18233320139147aa2`, Pages run `34087987096`, main Live Smoke `34088055637`, Auth Password Security Live Smoke `34088055663`, and Campaign 3000 Premium Live Smoke `34088055657` completed success. This deployment PASS does not establish Home V3 physical-device acceptance, Public Beta completion, conversion improvement, Privacy/Legal approval or Commercial GO. Issues #524/#545 physical verification remain **PENDING / NOT PASS / NOT FAIL** for their affected scopes; deployment/live-smoke evidence does not replace physical acceptance. Physical verification of the historical PR #537 password-recovery initialization fix also remains **PENDING** because a fresh recovery-email request was blocked by Supabase Auth `429 / over_email_send_rate_limit`; that block is not a recovery regression PASS or FAIL.
...
- [x] `CURRENT-RUNTIME.md` / `CURRENT-RELEASE.md` ระบุ current Home V3 candidate `6eac2ce642a907414260518d0435263b3e54f425`, deployment status **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE**, and Runtime merge/deployed SHA `46136f5ca6322847545289c18233320139147aa2`. Exact deployment evidence: Pages `34087987096`, main Live Smoke `34088055637`, Auth Password Security Live Smoke `34088055663`, Campaign 3000 Premium Live Smoke `34088055657` = SUCCESS. This is deployment evidence only, not physical/Public-Beta/Commercial acceptance.
...
- [x] Historical PR #201 public `release-meta.json` ถูกตรวจและมี deployed SHA `00bdcb7f432598e2eb82e71dcf1a9ec804ff1c4b2` กับ live Service Worker marker `kinaraidee-beta-v16`
