...
- Current browser/PWA runtime candidate: `6eac2ce642a907414260518d0435263b3e54f425` (Home V3 presentation candidate)
...
- Current Home V3 deployment evidence is pending. The last verified browser/PWA deployment trace belongs to historical PR #546 source `e0523e6cab49b09e910ba66f2ad18351f491d19a`, merged/deployed as `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`; Pages run `34013867862`, main Live Smoke `34013888880`, and Auth Password Security Live Smoke `34013888842` completed success. Those runs are retained only as historical/last-verified evidence and are not reused as Home V3 deployment PASS. Issues #524/#545 physical verification remain **PENDING / NOT PASS / NOT FAIL** for their affected scopes; deployment/live-smoke evidence does not replace physical acceptance. Physical verification of the historical PR #537 password-recovery initialization fix also remains **PENDING** because a fresh recovery-email request was blocked by Supabase Auth `429 / over_email_send_rate_limit`; that block is not a recovery regression PASS or FAIL.
...
- [ ] `CURRENT-RUNTIME.md` / `CURRENT-RELEASE.md` ระบุ current Home V3 candidate `6eac2ce642a907414260518d0435263b3e54f425` และสถานะ **PENDING FOR CURRENT RUNTIME DEPLOYMENT**; ยังไม่มี current deployed SHA สำหรับ Home V3.
- [x] Historical PR #546 Nearby remediation runtime มี canonical descendant Pages deployment + corresponding live-check evidence ตาม release contract — source `e0523e6cab49b09e910ba66f2ad18351f491d19a`, deployed descendant `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`, Pages `34013867862`, main Live Smoke `34013888880`, Auth Password Security Live Smoke `34013888842`. This trace is retained only as historical/last-verified deployment evidence and is not current Home V3 PASS. Issues #524/#545 physical verification remain **PENDING / NOT PASS / NOT FAIL**; deployment/live checks do not replace physical acceptance. Historical PR #537 password-recovery physical reset-specific recheck remains PENDING because recovery-email issuance was blocked by Supabase 429 rate limit.
