...
- Current browser/PWA runtime candidate: `de18711695bb94617c3cffa7767cb3943c0d2c05` (Issues #592/#593 remediation source candidate merged through PR #596)
...
- Last verified deployed browser/PWA descendant: `ca6a1c1bcb622ff241101a9c40aabfcd2a4b9793`.
...
- Current browser/PWA deployment evidence is **PASS for the deployment trace only**: runtime candidate `de18711695bb94617c3cffa7767cb3943c0d2c05` is verified through exact deployed descendant `ca6a1c1bcb622ff241101a9c40aabfcd2a4b9793`; Pages run `34382130901`, Kinaraidee Live Smoke `34382207087`, Auth Password Security Live Smoke `34382207152`, and Campaign 3000 Premium Live Smoke `34382207209` completed successfully for the PR #596 trace. Live release metadata and `kinaraidee-beta-v16` matched the deployed artifact. This deployment PASS does not itself establish Physical PASS, Public Beta completion, Privacy/Legal approval or Commercial GO. Issues #592/#593 have separate scoped **Physical PASS / CLOSED** from the fresh 2026-09-10 OPPO installed-PWA regression; Issues #524/#545 remain affected-iPhone physical PENDING. PR #590 / `efaa7778103fb95af68b5ae455f970c6115482c6` is CI-only and does not supersede the browser runtime.
...
- Historical PR #520 is the post-acceptance referral-summary browser runtime. After a scoped signed-in physical session returned privacy-safe `EDGE` and satisfied the render acceptance checks, `member.html` removed the caller-scoped `get_my_referral_summary()` fallback and now uses JWT-verified `member-referral-api` as the only browser retrieval path. Optional QA trace exposes only `EDGE/UNAVAILABLE`. Its deployment/security/physical evidence remains scoped and does not replace current PR #596 runtime.
