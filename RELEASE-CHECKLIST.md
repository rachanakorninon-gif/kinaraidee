...
- Current browser/PWA deployment evidence is **PASS for the deployment trace only**: Issue #585 offline-shell runtime candidate `0b6352af081f51ad9df2343022d0683b109d93a4` is verified through exact deployed descendant `af329c471c0335fd6e0812a8d5f75066ffb335cd`; Pages run `34676035335`, Toast Accessibility Live Smoke `34676056553`, Kinaraidee Live Smoke `34676056521`, Auth Password Security Live Smoke `34676056466`, Campaign 3000 Premium Live Smoke `34676056536`, and Premium Research Preview Live Smoke `34676056518` completed successfully for the PR #627 trace. The cache remains `kinaraidee-beta-v16`. This deployment PASS establishes online/offline app-shell parity for the toast controller only; it does not itself establish VoiceOver/TalkBack/keyboard Physical PASS, another-device PASS, full accessibility conformance, Public Beta completion, Privacy/Legal approval or Commercial GO. Issues #592/#593 retain separate scoped **Physical PASS / CLOSED** from the fresh 2026-09-10 OPPO installed-PWA regression; Issues #524/#545 remain affected-iPhone physical PENDING. The prior Issue #585 / PR #623 core-toast deployment remains historical verified evidence.
