...
- Current browser/PWA deployment evidence is **PASS for the deployment trace only**: Issue #584 runtime candidate `bde1bfed79696f6982852ca67d3ee4c8120c0c54` is verified through exact deployed descendant `2896748584a1058e9ba1bbc939f49f3b6faf4baf`; Pages run `34560369925`, Kinaraidee Live Smoke `34560396807`, Auth Password Security Live Smoke `34560396831`, and Campaign 3000 Premium Live Smoke `34560396804` completed successfully for the PR #614 trace. The cache remains `kinaraidee-beta-v16`. This deployment PASS does not itself establish VoiceOver/TalkBack/keyboard Physical PASS, another-device PASS, full accessibility conformance, Public Beta completion, Privacy/Legal approval or Commercial GO. Issues #592/#593 retain separate scoped **Physical PASS / CLOSED** from the fresh 2026-09-10 OPPO installed-PWA regression; Issues #524/#545 remain affected-iPhone physical PENDING. Historical Issue #583 / PR #602 deployment remains prior verified evidence only.
...
- Historical PR #520 is the post-acceptance referral-summary browser runtime. After a scoped signed-in physical session returned privacy-safe `EDGE` and satisfied the render acceptance checks, `member.html` removed the caller-scoped `get_my_referral_summary()` fallback and now uses JWT-verified `member-referral-api` as the only browser retrieval path. Optional QA trace exposes only `EDGE/UNAVAILABLE`. Its deployment/security/physical evidence remains scoped and does not replace current PR #614 runtime.
