...
- Current browser/PWA runtime candidate: `d24824948c9df1808178b9bb5a78a8f885086fb4` (canonical merged-main Home V3 contrast runtime retaining the TC-03 classification fix)
...
- Current browser/PWA deployment evidence is **PASS for the deployment trace only**: canonical runtime candidate `d24824948c9df1808178b9bb5a78a8f885086fb4` is verified through exact deployed descendant `f6b8598597edd874e69cbfe1dae941c919aaa037`; Pages run `34161708724` and main Live Smoke `34161744258` completed success for that exact deployed SHA. This deployment PASS does not establish TC-03 Physical PASS, Public Beta completion, conversion improvement, Privacy/Legal approval or Commercial GO. Issue #551 has a separate scoped Physical PASS/CLOSED on the affected OPPO standalone-PWA Home-nav path; Issue #552 / TC-03 remains **FAIL / OPEN** pending a fresh affected-device retest after the current deployment, and TC-08 allow remains **INCONCLUSIVE**.
...
- Historical PR #520 is the post-acceptance referral-summary browser runtime. After a scoped signed-in physical session returned privacy-safe `EDGE` and satisfied the render acceptance checks, `member.html` removed the caller-scoped `get_my_referral_summary()` fallback and now uses JWT-verified `member-referral-api` as the only browser retrieval path. Optional QA trace exposes only `EDGE/UNAVAILABLE`. Its deployment/security/physical evidence remains scoped and does not replace current Home V3.
...
- Historical PR #499 referral/acquisition runtime remains scoped deployment/acquisition evidence: source `f401ad758e40914a10245cfab08497f7cdb99f7d`, deployed descendant `02540bb61c3c62de4cfba34e92a876503765847d`, Pages `33811511793`, and Referral acquisition regression `33811512053`. This historical trace does not replace the current Home V3 runtime or establish a successful referred signup/referral conversion.
- Historical PR #373 Auth runtime remains scoped deployment/Auth evidence: source `6cd98bf2a2020b86fe2ab05e263dd59f7e4fb387`, deployed descendant `0cc3ec3ef4dda18f0d8e083d8ca0992ef77f844c`, Pages `33229525995`, Auth Password Security Live Smoke `33229548182`, and main Live Smoke `33229548190`. This historical trace does not replace the current Home V3 runtime.
...
- [x] `CURRENT-RUNTIME.md` / `CURRENT-RELEASE.md` ระบุ current Home V3 runtime candidate `d24824948c9df1808178b9bb5a78a8f885086fb4`, deployment status **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE**, and Runtime merge/deployed SHA `f6b8598597edd874e69cbfe1dae941c919aaa037`. Exact deployment evidence: Pages `34161708724` and main Live Smoke `34161744258` = SUCCESS. This is deployment evidence only, not TC-03 Physical/Public-Beta/Commercial acceptance; Issue #551 has separate scoped Physical PASS/CLOSED, while Issue #552 remains FAIL/OPEN pending fresh affected-device retest and TC-08 allow remains INCONCLUSIVE.
- [x] Historical PR #546 Nearby remediation runtime มี canonical descendant Pages deployment + corresponding live-check evidence ตาม release contract — source `e0523e6cab49b09e910ba66f2ad18351f491d19a`, deployed descendant `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`, Pages `34013867862`, main Live Smoke `34013888880`, Auth Password Security Live Smoke `34013888842`. This trace is retained only as historical deployment evidence and is not current Home V3 physical PASS. Issues #524/#545 physical verification remain **PENDING / NOT PASS / NOT FAIL**; deployment/live checks do not replace physical acceptance. Historical PR #537 password-recovery physical reset-specific recheck remains PENDING because recovery-email issuance was blocked by Supabase 429 rate limit.
- [x] Historical PR #520 referral-summary Edge-only runtime deployment + physical `EDGE` acceptance + post-cutover RPC privilege verification remain scoped historical evidence and are not replaced or generalized by Home V3.
