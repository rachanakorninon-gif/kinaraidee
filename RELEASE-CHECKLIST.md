...
- Current browser/PWA runtime candidate: `e0523e6cab49b09e910ba66f2ad18351f491d19a` (PR #546 Nearby iOS remediation)
...
- Current verified browser/PWA deployment trace: PR #546 source `e0523e6cab49b09e910ba66f2ad18351f491d19a` merged/deployed as `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`; Pages run `34013867862`, main Live Smoke `34013888880`, and Auth Password Security Live Smoke `34013888842` completed success. Issues #524/#545 physical verification remain **PENDING / NOT PASS / NOT FAIL** for their affected scopes; deployment/live-smoke evidence does not replace physical acceptance. Physical verification of the historical PR #537 password-recovery initialization fix also remains **PENDING** because a fresh recovery-email request was blocked by Supabase Auth `429 / over_email_send_rate_limit`; that block is not a recovery regression PASS or FAIL.
- Historical PR #520 is the post-acceptance referral-summary browser runtime. After a scoped signed-in physical session returned privacy-safe `EDGE` and satisfied the render acceptance checks, `member.html` removed the caller-scoped `get_my_referral_summary()` fallback and now uses JWT-verified `member-referral-api` as the only browser retrieval path. Optional QA trace exposes only `EDGE/UNAVAILABLE`. Its deployment/security/physical evidence remains scoped and does not replace current PR #546.
...
- Historical PR #499 referral/acquisition runtime remains scoped deployment/acquisition evidence: source `f401ad758e40914a10245cfab08497f7cdb99f7d`, deployed descendant `02540bb61c3c62de4cfba34e92a876503765847d`, Pages `33811511793`, and Referral acquisition regression `33811512053`. This historical trace does not replace the current PR #546 runtime or establish a successful referred signup/referral conversion.
- Historical PR #373 Auth runtime remains scoped deployment/Auth evidence: source `6cd98bf2a2020b86fe2ab05e263dd59f7e4fb387`, deployed descendant `0cc3ec3ef4dda18f0d8e083d8ca0992ef77f844c`, Pages `33229525995`, Auth Password Security Live Smoke `33229548182`, and main Live Smoke `33229548190`. This historical trace does not replace the current PR #546 runtime.
...
- [x] `CURRENT-RUNTIME.md` / `CURRENT-RELEASE.md` ระบุ current PR #546 runtime candidate และสถานะ **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE** สอดคล้องกัน
- [x] Current PR #546 Nearby remediation runtime มี canonical descendant Pages deployment + corresponding live-check evidence ตาม release contract — source `e0523e6cab49b09e910ba66f2ad18351f491d19a`, deployed descendant `a6db511e0bbd6be9038bbc63a06fb5e1702006d3`, Pages `34013867862`, main Live Smoke `34013888880`, Auth Password Security Live Smoke `34013888842`. Issues #524/#545 physical verification remain **PENDING / NOT PASS / NOT FAIL**; deployment/live checks do not replace physical acceptance. Historical PR #537 password-recovery physical reset-specific recheck remains PENDING because recovery-email issuance was blocked by Supabase 429 rate limit.
- [x] Historical PR #520 referral-summary Edge-only runtime deployment + physical `EDGE` acceptance + post-cutover RPC privilege verification remain scoped historical evidence and are not replaced or generalized by PR #546.
