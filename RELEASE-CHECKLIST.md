...
- Current browser/PWA runtime candidate: `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72` (PR #537 password-recovery initialization ordering fix)
...
- Current verified browser/PWA deployment trace: PR #537 source `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72` merged/deployed as `d7dd3a550b9a0d583cd7f3269a357b0187377d50`; Pages run `33975327442`, main Live Smoke `33975353656`, and Auth Password Security Live Smoke `33975353718` completed success. Physical verification of the reset initialization fix remains **PENDING** because the fresh recovery-email request was blocked by Supabase Auth `429 / over_email_send_rate_limit`; that block is not a recovery regression PASS or FAIL.
- Historical PR #520 is the post-acceptance referral-summary browser runtime. After a scoped signed-in physical session returned privacy-safe `EDGE` and satisfied the render acceptance checks, `member.html` removed the caller-scoped `get_my_referral_summary()` fallback and now uses JWT-verified `member-referral-api` as the only browser retrieval path. Optional QA trace exposes only `EDGE/UNAVAILABLE`. Its deployment/security/physical evidence remains scoped and does not replace current PR #537.
...
- Historical PR #499 referral/acquisition runtime remains scoped deployment/acquisition evidence: source `f401ad758e40914a10245cfab08497f7cdb99f7d`, deployed descendant `02540bb61c3c62de4cfba34e92a876503765847d`, Pages `33811511793`, and Referral acquisition regression `33811512053`. This historical trace does not replace the current PR #537 runtime or establish a successful referred signup/referral conversion.
- Historical PR #373 Auth runtime remains scoped deployment/Auth evidence: source `6cd98bf2a2020b86fe2ab05e263dd59f7e4fb387`, deployed descendant `0cc3ec3ef4dda18f0d8e083d8ca0992ef77f844c`, Pages `33229525995`, Auth Password Security Live Smoke `33229548182`, and main Live Smoke `33229548190`. This historical trace does not replace the current PR #537 runtime.
...
- [x] `CURRENT-RUNTIME.md` / `CURRENT-RELEASE.md` ระบุ current PR #537 runtime candidate และสถานะ **PASS FOR CURRENT BROWSER/PWA DEPLOYMENT TRACE** สอดคล้องกัน
- [x] Current PR #537 password-recovery initialization runtime มี canonical descendant Pages deployment + corresponding live-check evidence ตาม release contract — source `35cdf74b1c845ba61e46b86ec9e3c0e16e16eb72`, deployed descendant `d7dd3a550b9a0d583cd7f3269a357b0187377d50`, Pages `33975327442`, main Live Smoke `33975353656`, Auth Password Security Live Smoke `33975353718`. Physical verification ของ fix นี้ยัง PENDING เพราะ recovery-email issuance ถูก Supabase 429 rate limit block.
- [x] Historical PR #520 referral-summary Edge-only runtime deployment + physical `EDGE` acceptance + post-cutover RPC privilege verification remain scoped historical evidence and are not replaced or generalized by PR #537.
