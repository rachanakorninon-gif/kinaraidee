...
2. ตรวจหน้าแรก
3. ผลที่คาดหวัง: มีคำแนะนำการติดตั้งผ่าน Share → “เพิ่มไปยังหน้าจอโฮม” ที่ผู้ใช้เข้าใจได้
4. เมื่อติดตั้งและเปิดแบบ standalone แล้ว คำแนะนำไม่ควรรบกวนการใช้งาน
